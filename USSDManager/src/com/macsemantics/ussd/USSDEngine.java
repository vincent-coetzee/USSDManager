...
public class USSDEngine implements Serializable
	...
	private transient USSDWorkspace cachedWorkspace;
	...
	public void setCurrentMenu(USSDMenu menu)
		{
		currentMenu = menu;
		assert currentMenu != null : "USSDEngine.currentMenu should never be null";
		}
	...
	public USSDWorkspace workspace()
		...
		if (cachedWorkspace == null)
			{
			cachedWorkspace = USSDWorkspace.workspaceForUUID(workspaceUUID);
			}
